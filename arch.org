...
alias kbdintl="setxkbmap -layout us -variant intl"
...
nnoremap <leader>fe :Files %:p:h<cr>
nnoremap <leader>ff :edit %:p:h
...
(setq user-full-name "hss-mateus"
      ...
      doom-font (font-spec :family "IBM Plex Mono" :size 17)
...
export PATH="$HOME/.local/share/npm/bin:$HOME/.local/bin:$HOME/.ghcup/bin:$PATH"
